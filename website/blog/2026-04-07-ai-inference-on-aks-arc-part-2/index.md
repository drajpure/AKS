...
**Not covered:** Kubernetes fundamentals ([Learn](https://learn.microsoft.com/training/modules/intro-to-kubernetes/), [Upstream](https://kubernetes.io/docs/tutorials/kubernetes-basics/)), AKS enabled by Azure Arc onboarding ([overview](https://learn.microsoft.com/azure/azure-arc/kubernetes/overview), [docs](https://learn.microsoft.com/azure/aks/aksarc/)), model training/fine-tuning, and inference engine internals ([Triton](https://docs.nvidia.com/deeplearning/triton-inference-server/), [GPU Operator](https://docs.nvidia.com/datacenter/cloud-native/gpu-operator/latest/getting-started.html)).
